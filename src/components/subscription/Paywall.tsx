        ...
        >
          <View style={styles.introSection}>
            <Text style={styles.title}>
              Join over <Text style={styles.highlight}>100.000</Text> user
            </Text>
            <Text style={styles.subtitle}>Learning with vivi</Text>
          </View>
          ...
          <View style={styles.planCard}>
            ...
            <View style={styles.planHeader}>
              ...
              <View style={styles.planPriceContainer}>
                <Text style={styles.planPrice}>{selectedPlan.price} vnd.</Text>
